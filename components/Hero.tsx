...
export default function Hero() {
  return (
    ...
    >
      ...
      {/* ZMIANA: Zmniejszony padding dolny na desktopie (z pb-44 na pb-36), żeby nie wypychać tekstu za wysoko */}
      <div className="relative z-30 max-w-4xl sm:max-w-5xl mx-auto px-5 sm:px-6 text-center w-full pt-6 sm:pt-0 pb-28 sm:pb-32 lg:pb-36">
        {/* ZMIANA: Zmniejszony nagłówek na desktopie (z lg:text-7xl na lg:text-6xl) i lekko zwiększony margines pod nim */}
        <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black leading-tight sm:leading-[1.1] tracking-tight text-white mb-2 sm:mb-5">
          Wesela z klasą, pełnym parkietem i luzem.
        </h1>

        {/* ZMIANA: Zmniejszony nagłówek na desktopie (z lg:text-6xl na lg:text-5xl) i zmniejszony margines (z sm:mb-8 na sm:mb-6) */}
        <h2 className="text-2xl sm:text-4xl lg:text-5xl font-extralight leading-snug sm:leading-[1.15] tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-[#C6A97D] via-[#e2c992] to-[#a38555] mb-4 sm:mb-6">
          Muzyka na żywo, saksofon i show barmański.
        </h2>

        {/* ZMIANA: Zmniejszony margines pod opisem na desktopie (z sm:mb-12 na sm:mb-8), żeby przyciski były bliżej */}
        <p className="text-base sm:text-lg text-gray-300/90 max-w-xl sm:max-w-2xl mx-auto leading-relaxed mb-6 sm:mb-8">
      ...
      <div className="absolute bottom-0 left-0 right-0 z-40 bg-black/60 backdrop-blur-xl border-t border-white/[0.08]">
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4">
          <div className="py-4 sm:py-7 px-4 sm:px-6 flex flex-col items-center justify-center border-r border-white/[0.06]">
            <FiAward className="text-[#C6A97D] mb-1 sm:mb-2 text-sm sm:text-xl" />
            <p className="text-xl sm:text-3xl lg:text-4xl font-black text-white mb-0.5 sm:mb-1">
              100%
            </p>
          ...
          <div className="py-4 sm:py-7 px-4 sm:px-6 flex flex-col items-center justify-center md:border-r border-white/[0.06]">
            <FiLayers className="text-[#C6A97D] mb-1 sm:mb-2 text-sm sm:text-xl" />
            <p className="text-xl sm:text-3xl lg:text-4xl font-black text-[#C6A97D] mb-0.5 sm:mb-1">
              4w1
            </p>
            <p className="text-[9px] sm:text-[10px] text-gray-500 uppercase tracking-[0.15em] sm:tracking-[0.2em] font-medium">
              Pakiet
          ...
          <div className="py-4 sm:py-7 px-4 sm:px-6 flex flex-col items-center justify-center md:border-r border-white/[0.06]">
            <FiCalendar className="text-[#C6A97D] mb-1 sm:mb-2 text-sm sm:text-xl" />
            <p className="text-xl sm:text-3xl lg:text-4xl font-black text-white mb-0.5 sm:mb-1">
              150+
            </p>
            <p className="text-[9px] sm:text-[10px] text-gray-500 uppercase tracking-[0.15em] sm:tracking-[0.2em] font-medium">
          ...
          <div className="py-4 sm:py-7 px-4 sm:px-6 flex flex-col items-center justify-center">
            <FiClock className="text-[#C6A97D] mb-1 sm:mb-2 text-sm sm:text-xl" />
            <p className="text-xl sm:text-3xl lg:text-4xl font-black text-white mb-0.5 sm:mb-1">
              24h
            </p>
            <p className="text-[9px] sm:text-[10px] text-gray-500 uppercase tracking-[0.15em] sm:tracking-[0.2em] font-medium">
